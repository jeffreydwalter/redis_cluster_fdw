Redis Cluster Foreign Data Wrapper for PostgreSQL
=================================================

This is a foreign data wrapper (FDW) to connect [PostgreSQL](https://www.postgresql.org/)
to [Redis](http://redis.io/) key/value database. This FDW works with PostgreSQL **13+** and confirmed with some Redis versions near 6.0.

<img src="https://upload.wikimedia.org/wikipedia/commons/2/29/Postgresql_elephant.svg" align="center" height="100" alt="PostgreSQL"/>	+	<img src="https://avatars.githubusercontent.com/u/1529926" align="center" height="100" alt="Redis"/>	+	<img src="https://avatars.githubusercontent.com/u/1529926" align="center" height="100" alt="Redis"/>	+	<img src="https://avatars.githubusercontent.com/u/1529926" align="center" height="100" alt="Redis"/>    ...
...
- [Hiredis C interface **for clusters**](https://github.com/Nordix/hiredis-cluster) installed
on your system. You can checkout the `hiredis` from github or it might be available in [rpm or deb packages for your OS](https://pkgs.org/search/?q=hiredis). Warning: simple [hiredis](https://github.com/redis/hiredis) *isn't siutable* for this FDW.
...
- **nodes** as *string*, optional, default `127.0.0.1:6379`

  A comma separated list addresses or hostnames of the Redis cluster servers.
...
```sql
	GRANT USAGE ON FOREIGN SERVER redis_servers TO pguser;
```
...
- https://github.com/Nordix/hiredis-cluster/blob/master/README.md
- https://github.com/redis/hiredis/blob/master/README.md (not for clusters!)
